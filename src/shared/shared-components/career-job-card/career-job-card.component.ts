...
// import { EditJobAdComponent } from 'src/app/companies/company-jobs/edit/edit-job-ad.component';
// import { LoginModelComponent } from 'src/app/microsite/layouts/login-model/login-model.component';
import { AppComponentBase } from 'src/shared/app-component.base';
import { BookmarkJobDto, JobAdDto, JobApplicationDto } from 'src/shared/dto/company/job-ad-dto';
...
@Component({
  selector: 'app-career-job-card',
  templateUrl: './career-job-card.component.html',
  styleUrls: ['./career-job-card.component.css']
})
export class CareerJobCardComponent extends AppComponentBase implements OnInit {
  @Input() jobAd: JobAdDto;
  @Input() jobAdSearchRequest: JobAdSearchDtoDto;
  @Input() apiBaseUrl: string;
  @Input() isPublic: boolean;
  @Input() companyView = false;
 ...
 showLoginDialog(): void {
  ...
  // const loginDialogRef = this.dialog.open(LoginModelComponent);
