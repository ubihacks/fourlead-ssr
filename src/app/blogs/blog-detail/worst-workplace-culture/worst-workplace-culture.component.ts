...
@Component({
  selector: 'app-worst-workplace-culture',
  templateUrl: './worst-workplace-culture.component.html',
  styleUrls: ['../blog-detail.css']
})
export class WorstWorkplaceCultureComponent extends AppComponentBase implements OnInit {
